...
class PaliGemmaConfig():
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.text_config.num_image_tokens = (self.vision_config.image_size // self.vision_config.image_size) ** 2
...
class GemmaModel(nn.Module):
    ...
    def forward(
        ...
        # [Batch_Size, Seq_Len, Hidden_Size]
        normlizer = torch.tensor(self.config.hidden_size ** 0.5, dtype=hidden_states.dtype)
        hidden_states = hidden_states * normlizer
